...
class Person {
	...
	public Person(String name, int age) {
		// 1. 자기 자신을 가리키는 this
		this.name = name; // 대입 연산자 순서 오른쪽에서 왼쪽
		this.age = age;
	}
...
// xxx.java  하나의 파일 안에 여러개의 클래스를 작성 할 수 있다.
// 단 xxx.java 하나의 파일안에 public을 가지는 클래스는 단 하나만 선언할 수 있다.
// default 접근 제어 지시자 --> ch07에 있는 클래스들은 사용 가능하다.
class PersonMainTest {

	// static 메인함수는 잠시 자리를 빌려서 사용한다.
